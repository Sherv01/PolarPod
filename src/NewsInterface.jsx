...
const NewsInterface = () => {
  ...
  useEffect(() => {
    ...
    const fetchVideoUrl = async () => {
      try {
        const s3VideoUrl = `https://brainrot-media-bucket.s3.amazonaws.com/input/video.mp4`;
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-950 to-blue-950 text-white">
        ...
        <div className="fixed inset-0 opacity-20">
          <div
            ...
            style={{
              backgroundImage:
                'linear-gradient(#ff4444 1px, transparent 1px), linear-gradient(90deg, #4466ff 1px, transparent 1px)',
